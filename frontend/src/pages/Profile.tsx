...
import { usersApi, ordersApi, getAuthToken, clearAuthToken, type UserProfile, type Order } from '../api';
...
export default function Profile() {
  ...
  const displayOrders = orders.length > 0 ? orders : [
    { id: 1, order_number: '#NL-8902', created_at: '2024-10-05', status: 'Delivered', total: 1240.00, items: [] },
    { id: 2, order_number: '#NL-8741', created_at: '2024-09-28', status: 'Processing', total: 895.00, items: [] },
  ];
        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-12">
          ...
          <main className="lg:col-span-3 space-y-12">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              {[
                { label: 'Total Orders', value: String(displayOrders.length), icon: Package },
            ...
            <div className="bg-surface-container-low p-8 md:p-12 rounded-3xl editorial-shadow space-y-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-lg font-bold text-primary">{displayUser.phone}</p>
                </div>
                <div className="space-y-2">
                  <label className="text-xs font-label tracking-widest uppercase text-primary/40 font-bold">Default Address</label>
                  <p className="text-lg font-bold text-primary">{displayUser.address}</p>
                </div>
              </div>
