...
export default function Wishlist() {
  // Mocking some wishlist items for display
  const wishlistItems = ALL_PRODUCTS.slice(0, 2);
                      ...
                      <tr key={item.id} className="group hover:bg-surface-container-lowest transition-colors">
                        <td className="px-8 py-6">
                          <div className="flex items-center gap-6">
                            ...
                            <div>
                              ...
                              <p className="text-xs text-secondary font-bold uppercase tracking-widest mt-1">{item.category}</p>
                            </div>
                          </div>
                        </td>
                        <td className="px-8 py-6">
                        ...
                        <td className="px-8 py-6 text-right">
                          <div className="flex items-center justify-end gap-4">
                            ...
                            <button className="p-2 text-primary/40 hover:text-red-500 transition-colors">
                              <Trash2 size={18} />
                            </button>
                          </div>
                        </td>
