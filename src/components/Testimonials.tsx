      ...
      <div className="container mx-auto px-6 md:px-12 relative z-10">
        ...
        >
          ...
          <div className="flex flex-col items-center gap-2">
            ...
            <p className="font-label tracking-widest uppercase text-primary font-bold">Eleanor Rigby</p>
            <p className="text-sm text-on-surface-variant italic">Holistic Nutritionist</p>
          </div>
        </motion.div>
      </div>
