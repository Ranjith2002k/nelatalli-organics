...
const FEATURES = [
  ...
  { icon: Leaf, title: '100% Organic', desc: 'Pure botanical extracts' },
  { icon: Award, title: 'Certified Quality', desc: 'Tested for excellence' },
  { icon: Headphones, title: 'Expert Support', desc: 'Dedicated wellness guides' },
];
